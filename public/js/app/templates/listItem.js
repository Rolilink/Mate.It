...
buf.push("</div><a" + (jade.attr("href", "/properties/" + property._id, true, false)) + " class=\"btn btn-primary\">Ver Detalles</a></div><div class=\"col-md-8\"><h4>" + (jade.escape(null == (jade_interp = property.title) ? "" : jade_interp)) + "</h4><p><span class=\"price\">" + (jade.escape(null == (jade_interp = property.price + "$ - ") ? "" : jade_interp)) + "</span><span class=\"left\">" + (jade.escape(null == (jade_interp = (1 + property.habitants.length) + " personas") ? "" : jade_interp)) + "</span></p>");
